...
// Send information to mapx
Map mpElectraInformation;
mpElectraInformation.setString("OverrideDescription", sOverruleDescription)
_Map.setSubMapX("ElectraInformation", mpElectraInformation);
